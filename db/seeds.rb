...
b11 = Book.create(title: "Eloquent JavaScript: A Modern Introduction to Programming", author: "Marjin Haverbeke", description: "Probably the biggest standout of Eloquent JavaScript: A Modern Introduction to Programming is its heavy usage of practice exercises. Unlike other books on programming and JS, this book is a work of pure art.", publisher: "New York Press", weeks_on_list: 100, rank_this_week: 1)
b12 = Book.create(title: "Introduction to Algorithms", author: "Thomas H. Cormen", description: "The British cosmologist reviews efforts to create a unified theory of the universe.", publisher: "Bantam", weeks_on_list: 8, rank_this_week: 8)
...
Review.create(comment: "Eloquent JavaScript lets the reader digest all its knowledge easily thanks to an easy to understand and relatable language. Though not essentially a JavaScript book, it offers an introduction to programming using JavaScript.", author: "Marjin Haverbeke", book_id: b11.id)
Review.create(comment: "Eloquent JavaScript lets the reader digest all its knowledge easily thanks to an easy to understand and relatable language. Though not essentially a JavaScript book, it offers an introduction to programming using JavaScript.", author: "Marjin Haverbeke", book_id: b11.id)
Review.create(comment: "An excellent book to learn data structures and algorithms", author: "Marjin Haverbeke", book_id: b12.id)